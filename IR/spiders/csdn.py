...
class ExampleSpider(scrapy.Spider):
    ...
    def __init__(self, name=name):
        ...
        try:
            ...
            sql = "SELECT url_md5 FROM test WHERE title is not NULL"
    ...
    def parse(self, response):
        ...
        #对于csdn的blog，即保存页面信息及html，也获取链接
            ...
            #构造item
            item = IRItem()
            item["keywords"] = pymysql.escape_string(response.xpath('/html/head//meta[@name="keywords"]/@content').extract()[0])
            ...
            item["url_md5"] = md5
            item["pr"] = 0 
            raw_contents = response.xpath("//*[@id='content_views']//text()").extract()
            content = ""
